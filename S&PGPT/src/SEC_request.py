...
def analyze_question(api_key, text, filing_content):
    ...
    messages.append({"role": "user", "content": f"Query: {text}, Answer the query using the context provided. If the section provided is unable to answer the question state the current section and then please tell me what section of the document I need to look in and why."})
    data = {
        "model": "gpt-4o-mini",
        "messages": messages,
        "max_tokens": 500
